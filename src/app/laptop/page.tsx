  ...
  return (
    <main className="container py-10">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-2 text-4xl font-black capitalize">{title}</h1>
        <p className="mt-3 leading-7 text-slate-600">
          Güncel fiyatlar, teknik özellikler ve FiyatPilot puanlarıyla doğru ürünü daha hızlı seç.
          Filtreleri ve karşılaştırmayı kullanarak bütçene uygun seçenekleri daralt.
        </p>
      </div>
      ...
      <div className="mt-6 grid-auto">
        {(items.length ? items : products).map((p) => (
          <article className="surface overflow-hidden" key={p.id}>
            ...
            <div className="p-4">
              ...
              <a className="btn btn-primary mt-4 w-full" href={'/urun/' + p.slug}>
                Ürünü İncele
              </a>
            </div>
          </article>
