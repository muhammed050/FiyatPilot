      ...
      <div className="container flex min-h-16 items-center gap-3 py-2">
        <a href="/" aria-label="FiyatPilot ana sayfa" className="flex shrink-0 items-center gap-2.5">
          <span className="grid size-10 place-items-center rounded-xl bg-slate-950 text-white shadow-sm">
            <Icon className="size-5"><path d="M4 17 9 12l3 3 7-8" /><path d="M19 7h-4" /></Icon>
          </span>
          <span className="text-[1.15rem] font-extrabold tracking-[-.035em]">Fiyat<span className="text-blue-600">Pilot</span></span>
        </a>

        <form action="/ara" className="relative hidden min-w-0 flex-1 md:flex md:max-w-xl lg:mx-4" role="search">
          ...
          <input name="q" aria-label="Ürün ara" className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/80 py-2.5 pl-10 pr-4 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10" placeholder="Ürün, marka veya kategori ara..." />
        </form>
        ...
        <nav aria-label="Ana navigasyon" className="ml-auto flex items-center gap-1">
          ...
          <a href="/giris" className="ml-1 hidden min-h-10 items-center rounded-xl border border-slate-200 px-4 text-sm font-bold text-slate-800 transition hover:bg-slate-50 sm:inline-flex">Giriş yap</a>
        </nav>
      </div>
      <div className="container pb-2 md:hidden">
        <form action="/ara" className="relative" role="search">
          <Icon className="absolute left-3 top-1/2 size-[18px] -translate-y-1/2 text-slate-400"><circle cx="11" cy="11" r="7" /><path d="m20 20-4-4" /></Icon>
          <input name="q" aria-label="Ürün ara" className="h-10 w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-3 text-sm outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10" placeholder="Ürün ara..." />
        </form>
      </div>
    </header>
  );
