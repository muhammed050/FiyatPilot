  ...
  return <footer className="mt-16 border-t border-slate-200 bg-white">
    <div className="container grid gap-10 py-12 sm:grid-cols-2 md:grid-cols-4 md:py-14">
      <div className="sm:col-span-2 md:col-span-1">
        <a href="/" className="text-xl font-extrabold tracking-tight">Fiyat<span className="text-blue-600">Pilot</span></a>
    ...
    <div className="border-t border-slate-100"><div className="container py-5 text-xs leading-5 text-slate-400">© 2026 FiyatPilot. FiyatPilot bazı bağlantılardan komisyon kazanabilir.</div></div>
  </footer>;
}
